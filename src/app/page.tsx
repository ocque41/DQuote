        ...
        <div className="mx-auto flex max-w-5xl flex-col gap-10 px-6 text-center">
          <div className="space-y-4">
            ...
            <p className="mx-auto max-w-2xl text-balance text-lg text-muted-foreground">
              DQuote blends CPQ logic with a slide-native UX. Buyers explore curated packages, toggle add-ons, and sign + pay in
              a single flow.
            </p>
          </div>
      ...
      <section className="border-t bg-muted/40 py-16">
        <div className="mx-auto flex max-w-5xl flex-col gap-6 px-6 text-center">
          ...
          <p className="text-muted-foreground">
            Stripe Checkout handles deposits. Prisma + Neon keep proposal data in sync. Hook in Calendly for a post-accept kickoff
            meeting.
          </p>
        </div>
      </section>
